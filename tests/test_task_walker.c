...
static void test_offset_table_6_6(void) {
  ...
  if (OFFSETS_6_6.tasks_offset > 0 && OFFSETS_6_6.pid_offset > 0 &&
      OFFSETS_6_6.comm_offset > 0 && OFFSETS_6_6.real_parent_offset > 0 &&
      OFFSETS_6_6.files_offset > 0 && OFFSETS_6_6.nsproxy_offset > 0 &&
      OFFSETS_6_6.start_time_offset > 0 && OFFSETS_6_6.flags_offset > 0 &&
      OFFSETS_6_6.cred_egid_offset > 0 &&
      OFFSETS_6_6.cred_cap_effective_offset > 0 &&
      OFFSETS_6_6.tasks_offset < 0x1000 && OFFSETS_6_6.pid_offset < 0x1000) {
    PASS();
  } else {
...
static void test_offset_table_6_1(void) {
  ...
  if (OFFSETS_6_1.tasks_offset > 0 && OFFSETS_6_1.pid_offset > 0 &&
      OFFSETS_6_1.real_parent_offset > 0 && OFFSETS_6_1.files_offset > 0 &&
      OFFSETS_6_1.nsproxy_offset > 0 && OFFSETS_6_1.start_time_offset > 0 &&
      OFFSETS_6_1.flags_offset > 0 && OFFSETS_6_1.cred_egid_offset > 0 &&
...
static void test_vmi_process_size(void) {
  ...
  if (sizeof(proc) > 0 && proc.pid == 0 && proc.uid == 0 && proc.euid == 0 &&
      proc.cap_effective == 0 && proc.files_addr == 0 &&
      proc.nsproxy_addr == 0 && proc.start_time == 0 && proc.flags == 0) {
    PASS();
  } else {
